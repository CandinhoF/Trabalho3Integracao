...
planosDeEnsino = [
   {'Codigo':'BLU3024','Ano e Semestre':'2023-1', 'Turma':'unica', 'Nome do Professor':'Maiquel de Brito', 'Email': 'maiquel.b@ufsc.br', 'Horario e local da aula': 'quarta 13:30 e quinta 15:10 na sala A305',
 'Horario de atendimento': 'terca 10:00 sala C304', 'Metodologia': 'Aulas expositivas em quadro, utilizacao de transparencias ou slides, aulas praticas em laboratorio, trabalho pratico extraclasse e estudo dirigido',
 'Avaliacao': '3 trabalhos', 'Recuperacao': 'prova', 'Cronograma': 'Bancos de dados relacionais NoSQL,  Webservices e sistemas SCADA', 'Observacoes': 'sujeito a mudancas conforme necessario'},
 {'Codigo':'BLU8002', 'Ano e Semestre':'2023-1', 'Turma':'A', 'Nome do professor':'Mauri Ferrandin', 'Email do professor': 'mauri.ferrandin@ufsc.br', 'Horario e local da aula': 'segunda 10:10 e quarta 13:30 na sala A305',
 'Horario do atendimento': 'sexta 13:30 sala A204', 'Metodologia': 'Aulas expositivas em quadro, utilizacao de transparencias ou slides, aulas praticas em laboratorio, trabalho pratico extraclasse',
 'Avaliacao': '4 trabalhos e uma prova', 'Recuperacao': 'prova', 'Cronograma': 'Conexionismo, raciocinio incerto, aprendizado por reforco e fuzzy', 'Observacoes': 'sujeito a mudancas'},
